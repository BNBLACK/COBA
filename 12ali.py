...
satpam.login(token="EqJ7PnMLik2Rny6XIE83.juggmkkvlw6zSUXT/gRP0W.emxauJLqLjwREgTChYYyuaTpDw6bLknMqaT8gGIdY+s=")
satpam.loginResult()

cl = LINETCR.LINE() #Luffy
cl.login(token="EqqM0gyidGPsTZUcUL97.c3AuannFO2GnZDL3vUfOnW.axQ3F82AH+yxu9XSa7Otw4Rmb8Kjuikg/S3sA/2MIh4=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EqvlD9Ahs6AIgPM9KWp7.O0FGNtYKmYt9Qd28sB065W.K+a1X+meq3VpwRr5rSo7CgcVMCRzaUGdSVqT2BEf0nE=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="Eq1mUxl8P5H0dp1bO8xd.+YJQegCzmlp/DpdIuBUA7q.lEg979tWexkVy1kgPNnZ/XblOz7fD6ZqxW8hf3DfEkY=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Eq1mUxl8P5H0dp1bO8xd.+YJQegCzmlp/DpdIuBUA7q.lEg979tWexkVy1kgPNnZ/XblOz7fD6ZqxW8hf3DfEkY=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EqiImSxP6mVCPRyIE2gb.T+PTxkW781eTVFAaiqIDgW.sEAnJbikZtt2D4FCUMf2B4TzkdtKnsBmoANIkTpQwII=")
ks.loginResult()

ka = LINETCR.LINE() #Franky
ka.login(token="Eq62wokQWIlwe4NuGQLf.5c3HczbPOjO8q9e33MwtRW.2nEnxZ95VwhUVhOgR0LDV2vH/A5eEwZskYyFOt23K9M=")
ka.loginResult()

kb = LINETCR.LINE() #Brook
kb.login(token="EqWCTfHrRkQLUclv5bb2.LoKC+gOX+KZYr18Tp2m1KG.riKioJFMQ/pfhaIdynFubMoAafD/o91FVPE2Ip7INSo=")
kb.loginResult()

ko = LINETCR.LINE() #Nami
ko.login(token="EqA6jt9hwIXMF8qul0de.ZaKoWwkupm1w9r28+X/GFG.rAJuXjIR9uHmMoF76RnHZnRPb9LNR7dxvbMTft9Iipk=")
ko.loginResult()

ke = LINETCR.LINE() #Robin
ke.login(token="EqlkNkvQtNxeueeY2j42.YYeoM22Vhks1am4XV4nUSG.vfe9Ilt7DfNwH/G0+ldS2cwakxThrOsbN1DgBdKqKKs=")
ke.loginResult()

ku = LINETCR.LINE() # Jinbei
ku.login(token="Eql7Kbsuw7gtyAY8JfQe.BCvAaI8QeUkvdwYj/dr3hG.zOO3lHmWETuSVzMBvq7s+z8rgBjjvfqmGPRGiudJniw=")
ku.loginResult()
...
k1.login(token="EqvlD9Ahs6AIgPM9KWp7.O0FGNtYKmYt9Qd28sB065W.K+a1X+meq3VpwRr5rSo7CgcVMCRzaUGdSVqT2BEf0nE=")
k1.loginResult()

print "login success Cuy"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage =""" ^[Ali Baba]^
OWNER •Ali Baba•"""
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"u25418630a2952d6e99b2ec6df86ae9d3","u965898f9a4f19279243d460473e1a392","u17111ddff4688496b73d23984d8c97ef","ua347e09d3ca43324fda83dbc49bd3ae7"]
admin=["u25418630a2952d6e99b2ec6df86ae9d3","u965898f9a4f19279243d460473e1a392","u17111ddff4688496b73d23984d8c97ef","ua347e09d3ca43324fda83dbc49bd3ae7","uaa4a118d8bfa5051da06015d013e5994","u862ab2324f63bd912b547c79505cca72","ud43181d7e12eb605728a06b6ff99bd66","udd5ebfb3d92d40f71f9c15d72a303657"]
owner=["u25418630a2952d6e99b2ec6df86ae9d3","u965898f9a4f19279243d460473e1a392","u17111ddff4688496b73d23984d8c97ef","ua347e09d3ca43324fda83dbc49bd3ae7"]
wait = {
    'contact':False,
    'autoJoin':True,
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["My Bot","My bot"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Love u","Miss u"]:
            	 if msg.from_ in admin:
