...
cl.login(token="Eq7EEXiCGIS1sRq5uKJ2.LLIy/AtXKNKKpuyeC/gJKG.4AG8l95nRknVPOTTuoLit8+3EPBO5osQDRf+8xz02UY=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 1
ki.login(token="EqMSqrVUlzKxpSsOzApf.fXeD3+rOHjA3psoytyYx7W.5eSbYy0YTLmB2Q3kgHO0b7urgDRQIYunxLqAjtYrDYg=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="EqWhKvzj9d9flQIAtfwd.+YJQegCzmlp/DpdIuBUA7q.Pm1NK7u5kUSqMF+9a2mrs407l6T2SP2zP8yBH+nOW7c=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 3
kc.login(token="EqmskeB85gxLncHqPxA2.8ZPbh5EZsGVtQaVVMZTemG.j/Cxx6BhtBSYEhBf1VDMEdv/dElmh7GJLOwGEdPMtHE=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 4
ks.login(token="EqmskeB85gxLncHqPxA2.8ZPbh5EZsGVtQaVVMZTemG.j/Cxx6BhtBSYEhBf1VDMEdv/dElmh7GJLOwGEdPMtHE=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 5
ka.login(token="EqiqnfPk4q3G3de6DsPb.T+PTxkW781eTVFAaiqIDgW.x5eGjkwlR2gYfIZANhIkcfy9xFbFkTuxVd7T+fEesJs=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 6
kb.login(token="EqSf5QOxHp8BzYSpIxGf.5c3HczbPOjO8q9e33MwtRW.ioYY0f1RpJDKSb0be+DK23SnJQRyCbgXpUtqKw2ylK8=")
kb.loginResult()

ko = LINETCR.LINE() #Bot 7
ko.login(token="EqDas1PwXsWfwxXJGXG2.LoKC+gOX+KZYr18Tp2m1KG.Z+LSacZWxt9Bz/POpZ3acIZC3TFQzvnrV6qLCFWS7ow=")
ko.loginResult()

ke = LINETCR.LINE() #Bot 8
ke.login(token="EqKlTuUSyCmyusW10NM7.c3AuannFO2GnZDL3vUfOnW.nu97XFcU6qRtWpJmX8iVP/VC6pZHLgvtlWUHtrXw2tw=")
ke.loginResult()

ku = LINETCR.LINE() #Bot 9
ku.login(token="EqQvmaHu5dzm5me73yK7.O0FGNtYKmYt9Qd28sB065W.pAjt7ONRx7dHgIhNtNw14FyXgmil1T0vpjcGvzsfKRE=")
ku.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"u25418630a2952d6e99b2ec6df86ae9d3","uaa4a118d8bfa5051da06015d013e5994","u862ab2324f63bd912b547c79505cca72","ud43181d7e12eb605728a06b6ff99bd66","udd5ebfb3d92d40f71f9c15d72a303657","u17111ddff4688496b73d23984d8c97ef"]
admin=["u25418630a2952d6e99b2ec6df86ae9d3","uaa4a118d8bfa5051da06015d013e5994","u862ab2324f63bd912b547c79505cca72","ud43181d7e12eb605728a06b6ff99bd66","udd5ebfb3d92d40f71f9c15d72a303657","u17111ddff4688496b73d23984d8c97ef"]
owner=["u25418630a2952d6e99b2ec6df86ae9d3","u965898f9a4f19279243d460473e1a392"]
wait = {
    'contact':False,
    'autoJoin':True,
